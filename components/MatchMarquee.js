    ...
    >
      <div className="flex flex-col lg:flex-row w-full md:gap-x-4 wrapper-content">
       ...
       Ready to grade?
              ...
              <div className="text-[16px] md:text-[20px]  leading-[1.4]  lg:leading-[1.2] lg:pr-10">
Apply to join our Community Grader Onboarding on July 2 and 3 at RunAsYouAre. If selected, you&apos;ll complete two short sessions, then be added to the pool for future grading.
          </div>
