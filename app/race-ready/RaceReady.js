...
export default function RaceReady() {
  return (
    <div className="flex flex-col" >
      <div className="hero-gradient">
        ...
        >
          <div className=" flex flex-col w-full lg:w-4/5 justify-center text-center lg:text-left lg:pr-[9rem] pr-5">
            <div
              className={
        ...
        >
          <div className="w-full   mx-auto flex flex-col text-center items-center">
            ...
            <p className="mt-10 wrapper text-[16px] md:text-[20px] leading-[1.4] lg:leading-[1.2]">
            ...
            <div className="flex flex-1 relative ">
              <div className="flex-col flex flex-1 justify-center md:items-center">
                <div className="">
                  ...
                  <ol className="grid grid-cols-2 gap-x-6 mt-2 text-[14px] lg:text-[16px] leading-[1.6] list-disc list-inside">

                    <li className="pl-2">April 29, 2025</li>
                    <li className="pl-2">May 6, 2025</li>
                    <li className="pl-2">May 13, 2025</li>
                    <li className="pl-2">May 20, 2025</li>
                    <li className="pl-2">May 27, 2025</li>
                    <li className="pl-2">June 3, 2025</li>
                    <li className="pl-2">June 10, 2025</li>
                    <li className="pl-2">June 17, 2025</li>
                  </ol>
                </div>
              </div>
            </div>
  ...
  {[
    {
      question: "What kind of exercises will I be doing in the sessions?",
      answer:
    ...
    {
      question: "How much attention will I get in a small group setting?",
      answer:
  ...
  {[
    {
      question: "How does insurance coverage work for this program?",
      answer:
  ...
  <h2 className="text-2xl font-semibold mt-8 mb-4">Footwear & Perks</h2>
  {[
    {
