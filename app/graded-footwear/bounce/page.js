...
import { getHighBounceShoes } from "@/serverActions/fetchShoesByABS";
...
export const metadata = {
  title: "RunReady - Graded Footwear / Bounce",
};
export default async function HighAbsorb() {
  ...
  const shoes = await getHighBounceShoes();
